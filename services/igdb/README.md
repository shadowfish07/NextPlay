...
The playtime calendar uses one square per civil day, Monday-to-Sunday rows and horizontally scrollable weeks. Switching between daily, cumulative and calendar views preserves the selected range (7 days, 30 days, one year or all recorded dates). Green intensity represents observed minutes (0, 1–29, 30–59, 60–119, ≥120); missing observations are outlined; partial days use their recorded minutes without a separate border or incomplete-record notice. Selecting a square opens the existing daily breakdown.
